export const TRANSLATION_KEYS = [
  ...
  'tutorial-layout',
  'tutorial-service',
  'annotation-finance-payment',
  'annotation-finance-warehouse',
  'annotation-portfolio-cloud',
  'annotation-portfolio-unified',
  'annotation-external-inbound',
  'annotation-external-outbound',
  'annotation-aggregator-docs',
  'annotation-aggregator-ai',
